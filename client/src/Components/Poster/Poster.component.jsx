                    ...
                    <div className="w-full h-full flex rounded-lg shadow-lg lg:hover:shadow-2xl lg:w-72 md:flex-col bg-white">
                        ...
                        <div className="px-2 w-full py-2 gap-1">
                            ...
                            <div className="flex justify-center items-center w-full h-8">
                                <button className="w-full h-full bg-white text-tara-0 text-sm px-3 py-1 rounded-sm border-2 hover:bg-tara-0 border-black font-bold hover:text-white"><a href={isValid ? props.link : "/login" } target={isValid ? "_blank" : "_self" } rel="fnfd" className="w-full h-full">GET COURSE</a></button>
                            </div>
